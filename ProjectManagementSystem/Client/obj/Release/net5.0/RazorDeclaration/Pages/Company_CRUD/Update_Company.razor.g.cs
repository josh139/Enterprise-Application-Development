...
#line 39 "C:\Users\jbors\source\repos\ProjectManagementSystem\Client\Pages\Company_CRUD\Update_Company.razor"
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {
            Console.WriteLine("Exception occurred with GET (a) company");
        }
    }
    ...
    protected async Task HandleValidSubmit()
    {
        try
        {
            ...
            var response = await Http.PutAsJsonAsync($"/api/Companies/{Company.Id}", newCompany);
        ...
        {
            Console.WriteLine("Exception occurred with PUT company");
        }
    }
